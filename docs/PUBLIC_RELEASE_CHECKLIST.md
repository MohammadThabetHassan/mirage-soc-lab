...
| Social preview           | `docs/assets/mirage-social-preview.jpg` is 1280×640 and under 1 MB.                                   | Upload it in **Settings → Social preview → Edit → Upload an image**.                                                                                            |
...
Second, open the repository **Settings** page and upload the prepared social-preview JPEG. GitHub recommends a 1280×640 image and limits social preview uploads to PNG, JPG, or GIF files below 1 MB.[1] The file in this repository matches that guidance.
